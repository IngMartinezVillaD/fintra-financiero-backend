package co.pluto.controllers.errors_handler;

import co.pluto.dto.response.ApiResponseDto;
import co.pluto.dto.response.BaseErrorResponseDto;
...
public class GlobalExceptionHandler {
  ...
  public ResponseEntity<BaseErrorResponseDto> handleBusinessException(BusinessException ex) {
    log.info("BusinessException: {}", ex.getMessage());
    return ResponseEntity.status(HttpStatus.UNPROCESSABLE_ENTITY).body(BaseErrorResponseDto.builder()
        .status(ERROR_STATUS)
