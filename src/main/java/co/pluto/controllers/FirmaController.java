...
public class FirmaController extends BaseController {
  ...
  @Operation(summary = "Marcar firma como completada manualmente (sin integración Thomas Signe)")
  @PreAuthorize("hasAnyAuthority('ADMIN','TESORERIA')")
  public ResponseEntity<ApiResponseDto> marcarManual(@PathVariable Long id) {
    return createSuccessResponse(firmaService.marcarFirmadaManual(id));
  }
}
