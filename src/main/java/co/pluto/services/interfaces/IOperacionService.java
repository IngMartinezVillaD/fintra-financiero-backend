...
import co.pluto.dto.response.operaciones.AvisoTramoAnteriorDto;
import co.pluto.dto.response.operaciones.OperacionListItemDto;
import co.pluto.dto.response.operaciones.OperacionResponseDto;
...
public interface IOperacionService {
  ...
  // ── Historial ────────────────────────────────────────
  java.util.List<co.pluto.dto.response.operaciones.EventoPipelineDto> historial(Long id);
}
