...
@Entity
@Table(name = "cupos_rotativos", schema = "prestamos")
...
public class CupoRotativoEntity {
  ...
  @Column(name = "valor_cupo", precision = 19, scale = 6, nullable = false)
  private BigDecimal valorCupo;

  @Column(name = "saldo_disponible", precision = 19, scale = 6, nullable = false)
